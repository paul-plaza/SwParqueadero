<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Puestos.aspx.cs" Inherits="SwParqueadero.Mantenimiento.Puestos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <hr />
    <div class="panel panel-info">
        <div class="panel-heading">
            <h2 class="panel-title"><em>Puestos de Parqueadero</em></h2>
        </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1">Parqueadero</span>
                                    <asp:DropDownList ID="ddlParqueadero" CssClass="btn btn-default dropdown-toggle col-md-12"
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtDescripcion" CssClass="form-control" placeholder="Ingrese Nombre Puesto"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <asp:Panel ID="pnl_defbotonbuscar" runat="server" CssClass="form-inline col-md-12"
                                        ...
                                        <asp:TextBox ID="txtBuscar" placeholder="(Texto a buscar)" runat="server"
                                        ...
                                        <asp:Button ID="btnBuscarTodos" runat="server" CausesValidation="False" class="btn btn-primary"
